...
los corrimientos de Doppler según la ubicación de cada DCP puede ayudar a separarlos en frecuencia.
...
generador de RF para ser moduladas con una frecuencia de portadora igual a la mínima frecuencia observable por el receptor a probar. 
